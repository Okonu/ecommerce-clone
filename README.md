...
25. Discount codes
26. Responsive public pages, responsive administration, responsive vendor pages
27. Advanced search with treeView categories
28. Easy manage of products (new filed for every added language, subcategories are easy to manage)
29. Advanced sorting and order products
...
Little explanation about the installation - if you paste installation of project in directory something like http://localhost:3306/SHOP, you must 
set this directory to application/config/config.php - $config['base_url'] = 'http://localhost:3306/SHOP'; and must remove from .htaccess file
...
in root http://localhost:3306 directory or if you want to be in other directory just set virtual host for this and point him to there.
